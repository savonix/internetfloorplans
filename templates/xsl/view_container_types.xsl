...
<xsl:template name="content">
	...
	<tr>	
			...
			<tr class="row{position() mod 2}">
				<td>
					<font class="two"><a href="/acc/link/containers/edit/&amp;container_id={container_id}"><xsl:value-of select="name"/></a></font>
				</td>
				<td>
					<font class="two"><xsl:value-of select="description"/></font>
				</td>
				<td>
					<font class="one"><a href="/acc/link/containers/edit/&amp;container_id={container_id}">Edit</a></font></td>
				<td>
					<font class="one"><a href="/acc/link/containers/delete/&amp;container_id={container_id}" onclick="return confirm('Are you sure you want to delete this container type?')">Delete</a></font></td>
			</tr>
			</xsl:for-each>
