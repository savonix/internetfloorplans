...
<table>
    <tr>
        <td>
            Equipment Type Image ID: <xsl:value-of select="//equipment_type_image_id"/>
        </td>
    </tr>
    <tr>
        <td>
            Equipment ID: <xsl:value-of select="//equipment_id"/>
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        <td>
            Location Equipment ID: <xsl:value-of select="//location_equipment_id"/>
        </td>
    </tr>
    <tr>
        <td>
...
<script type="text/javascript">
    var mywidth = 260;
    var myheight = 450;
    var mymoviestringb = "{//link_prefix}ifp-equipment-type-image-server&amp;equipment_type_image_id={equipment_type_image_id}&amp;equipment_type_id=<xsl:value-of select='//equipment_type_id'/>&amp;equipment_id={//equipment_id}&amp;w=260&amp;h=450";
