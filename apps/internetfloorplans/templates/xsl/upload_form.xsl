...
<table>
    <tr>
        <td> <xsl:value-of select="/_R_/i18n/file_title"/>:</td>
        <td><input type="text" name="name" value="{//_post/name}"/></td>
    </tr>
    <xsl:if test="count(//static_file_types) &gt; 0">
    <tr>
        <td> <xsl:value-of select="/_R_/i18n/file_type"/>:</td>
        <td>
    ...
    <tr>
        <td> <xsl:value-of select="/_R_/i18n/file_to_upload"/>: * </td>
        <td><input type="file" name="file"/></td>
    </tr>
    <tr>
        <td><xsl:value-of select="/_R_/i18n/comments"/>:</td>
