...
// cn = content
$cn_array['image_pointer'] = Path::get("//get_image_pointers_by_id/image_pointer","flow");
$cn_array['thumb_pointer'] = Path::get("//get_image_pointers_by_id/thumb_pointer","flow");
$cn_array['equipment_type_container_id'] = Path::get("//get_image_pointers_by_id/equipment_type_container_id","flow");
